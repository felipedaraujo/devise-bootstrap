...
class ProtocolsControllerTest < ActionController::TestCase
  ...
  test "should create protocol" do
    assert_difference('Protocol.count') do
      post :create, protocol: { author: @protocol.author, name: @protocol.name, procedure: @protocol.procedure, source: @protocol.source }
    end
  ...
  test "should update protocol" do
    patch :update, id: @protocol, protocol: { author: @protocol.author, name: @protocol.name, procedure: @protocol.procedure, source: @protocol.source }
    assert_redirected_to protocol_path(assigns(:protocol))
  end
